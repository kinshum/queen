...
public interface AppConstant {
	 ...
	 * mybatis 扫描包
	 */
	String MYBATIS_SCAN_PACAKAGES = BASE_PACKAGES+".**.mapper.**";
	 ...
	 * 消息队列模块名称
	 */
	String APPLICATION_ROCKETMQ_NAME = APPLICATION_NAME_PREFIX + "rocketmq";

	/**
	 * 调度任务模块名称
	 */
	String APPLICATION_SCHEDULE_NAME = APPLICATION_NAME_PREFIX + "schedule";
