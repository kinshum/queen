...
public class QueenFileUtil {
	 ...
	 * @return QueenFile
	 */
	public static QueenFile getFile(MultipartFile file) {
	 ...
	 * @return QueenFile
	 */
	public static QueenFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return QueenFile
	 */
	public static QueenFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new QueenFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return QueenFile
	 */
	public static List<QueenFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return QueenFile
	 */
	public static List<QueenFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return QueenFile
	 */
	public static List<QueenFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<QueenFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new QueenFile(file, dir, path, virtualPath));
		}
		return list;
	}
