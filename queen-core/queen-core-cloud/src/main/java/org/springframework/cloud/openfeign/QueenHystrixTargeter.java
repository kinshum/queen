...
import com.queen.core.cloud.feign.QueenFallbackFactory;
import feign.Feign;
import feign.Target;
...
/**
 * 添加 queen 默认的 fallbackFactory
 *
 * @author jensen
 */
@SuppressWarnings("unchecked")
public class QueenHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		// queen 默认的 fallbackFactory
		QueenFallbackFactory queenFallbackFactory = new QueenFallbackFactory(target);
		return (T) builder.target(target, queenFallbackFactory);
	}
