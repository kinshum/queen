...
import com.queen.core.cloud.feign.QueenFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class QueenFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return QueenFeignAutoConfiguration.class;
	}
