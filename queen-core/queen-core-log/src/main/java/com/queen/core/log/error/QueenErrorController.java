 ...
 * @author jensen
 */
public class QueenErrorController extends BasicErrorController {

	public QueenErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
