package com.queen.schedule.config.quartz;
...
public class JobUtil {
    ...
    public TriggerKey getTriggerKeyByJob(String jobName, String jobGroup) {
        String triggerName = CommonConstant.TRIGGER_PREFIX + jobName;
        String triggerGroup = CommonConstant.TRIGGER_PREFIX + jobGroup;
